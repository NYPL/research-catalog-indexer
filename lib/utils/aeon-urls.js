...
const LOCATION_LABEL_MAP = {
  ...
  LPATH: 'ReCAP',
  SASBG: 'Schwarzman Berg Collection',
  SASBGSB: 'Berg Collection',
  SASJD: 'Schwarzman Dorot Jewish Division',
  SASMP: 'Schwarzman Map Division',
  SASMS: 'Schwarzman Manuscripts and Archives Division',
  SASPF: 'Schwarzman Pforzheimer Collection',
  SASPH: 'Schwarzman Prints and Photographs Division',
  SASPR: 'Schwarzman Prints and Photographs Division',
  SASRB: 'Schwarzman Rare Book Division',
  SCHMIRS: 'Schomburg Moving Images and Recorded Sound',
  SCHRB: 'Schomburg Center Manuscripts, Archives and Rare Books',
  SCHMA: 'Schomburg Center Manuscripts, Archives and Rare Books',
  SCHPP: 'Schomburg Center Photographs and Prints'
}
