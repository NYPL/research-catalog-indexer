...
module.exports = {
  ...
  writeRecords: async (n) => Promise.resolve({ totalProcessed: n }),
  EsBib,
  bibIdentifiersForItems: async (items) => await Promise.all(items.map(() => Promise.resolve([{ id: 'b12345678', nyplSource: 'Tatooine' }])))
}
