...
class EsBib extends EsBase {
  ...
  */
  ...
  series_displayPacked () {
    return this._buildMarcAFieldPacked(['490'])
  }

  seriesUniformTitle_displayPacked () {
    return this._buildMarcAFieldPacked(['830'])
  }
 ...
 */
  ...
  /**
   * Build packed fields: returns an array of "a||full" strings from unserialized varFields
   *
   * @param {string[]} marcTags - MARC tags to extract, e.g. ['490', '830', '800', '810', '811']
   * @param {string[]} subfieldsToUse - Optional: subfields to treat as "a" (defaults to ['a'])
   *
   * @return {string[]}
   */
  _buildMarcAFieldPacked (marcTags, subfieldsToUse = ['a']) {
