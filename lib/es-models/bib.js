...
class EsBib extends EsBase {
  ...
  */
  ...
  series_displayComponents () {
    ...
    return this._extractDisplayComponents(this.browseTermData.series.filter(Boolean), { stripTrailingVX: true })
  }

  seriesUniformTitle_displayComponents () {
    // Using ContributorVarfield to construct,
    // name portion corresponds to the indexed $a, d, f, g, h, k, l, m, n, o, p, r, s, t subfields
