 ...
 */
  ...
  _nameTitleRoleValueToIndex (primary = true) {
    return this._buildBrowseableTermData(ContributorVarfield, 'nameTitleRole', primary)
  }

  _subjectLiteralValueToIndex (primary = true) {
    return this._buildBrowseableTermData(SubjectVarfield, 'subjectLiteral', primary)
  }
