...
class EsBib extends EsBase {
  ...
  */
  ...
  browseableContributorRole_packed () {
    ...
    const contributions = contributors.flatMap(term => term ? [term.name, ...term.nameRoles] : [])
  ...
  */
  ...
  parallelSeries () {
    return this._parallelValueToIndexFromBasicMapping('series')
  }

  parallelSeriesStatement () {
    return this._parallelValueToIndexFromBasicMapping('seriesStatement')
  }
