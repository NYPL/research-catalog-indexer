...
const { SubjectVarfield } = require('@nypl/browse-term')
...
class EsBib extends EsBase {
  ...
  */
  ...
  parallelContributorLiteral () {
    return this._parallelValueToIndexFromBasicMapping('contributorLiteral')
  }

  parallelCreatorLiteral () {
    return this._parallelValueToIndexFromBasicMapping('creatorLiteral')
  }
 ...
 */
  ...
  _normalizeItemShelfMark (shelfMark) {
    if (!this.__normalizedShelfmarkLookup) {
      ...
      console.log('Built __normalizedShelfmarkLookup: ', this.__normalizedShelfmarkLookup)
    }
