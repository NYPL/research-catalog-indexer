...
class EsBib extends EsBase {
  ...
  */
  ...
  parallelNameTitleRole () {
    return this._buildBrowseableTermData(ContributorVarfield, 'nameTitleRole', false)
  }
  ...
  parallelAddedAuthorTitle () {
    return this._valueToIndexFromBasicMapping('addedAuthorTitle', false)
  }

  parallelContributorLiteral () {
    return this._buildBrowseableTermData(ContributorVarfield, 'contributorLiteral', false)
      ?.map(({ label }) => label)
  }

  parallelCreatorLiteral () {
    return this._buildBrowseableTermData(ContributorVarfield, 'creatorLiteral', false)
      .map((obj) => obj.label)
  }

  parallelDescription () {
    return this._valueToIndexFromBasicMapping('description', false)
  }

  parallelEditionStatement () {
    return this._valueToIndexFromBasicMapping('editionStatement', false)
  }
  ...
  parallelPlaceOfPublication () {
    return this._valueToIndexFromBasicMapping('placeOfPublication', false)
  }
  ...
  parallelPublicationStatement () {
    return this._valueToIndexFromBasicMapping('publicationStatement', false)
  }
  ...
  parallelSubjectLiteral () {
    return this._buildBrowseableTermData(SubjectVarfield, 'subjectLiteral', false)
  }

  parallelTableOfContents () {
    return this._valueToIndexFromBasicMapping('tableOfContents', false)
  }
