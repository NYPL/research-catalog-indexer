...
class EsBib extends EsBase {
  ...
  authorNameTitle () {
    const values = this.browseTermData.authorNameTitle
 ...
 */
  ...
  _populateBrowseTermData () {
    this.browseTermData = {}
    this.browseTermData.authorNameTitle = this._buildBrowseableTermData(ContributorVarfield, 'authorNameTitle')
