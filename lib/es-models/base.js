...
class EsBase {
   ...
   *  plainobject by calling `.toPlainObject()`.
   *
  ...
  toPlainObject (schema) {
    ...
    properties.forEach((property) => {
      ...
      // if the schema property correspond to holdings or items
      // const isChildMapping = !!schema[property]?.properties?.uri
      let value
      try {
        value = this[property]()
      } catch (e) {
      ...
      if (this[property].toPlainObject) {
