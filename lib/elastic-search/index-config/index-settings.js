  ...
  analysis: {
    ...
    normalizer: {
      ...
      punctuation_and_lowercase_normalizer: {
        filter: ['icu_folding', 'lowercase'],
        type: 'custom',
        char_filter: ['strip_punctuation', 'strip_combining_marks']
      },
      identifier_normalizer: {
        type: 'custom',
        char_filter: ['clean_identifier_filter']
      },
      shelfmark_normalizer: {
        filter: ['icu_folding', 'lowercase'],
        type: 'custom',
        char_filter: ['strip_shelfmark_punctuation']
      },
      sort_normalizer: {
        filter: ['icu_folding', 'lowercase'],
        type: 'custom',
        char_filter: ['strip_leading_articles']
      }
    },
    analyzer: {
      shingles_analyzer: {
        filter: ['lowercase', 'icu_folding', 'shingles_filter'],
        type: 'custom',
        tokenizer: 'standard'
      },
      folding_stemming_analyzer: {
        ...
        char_filter: ['extended_punctuation_char_filter', 'strip_punctuation'],
...
const specificSettingsPaths = ['./identifiers.json']
for (const path of specificSettingsPaths) {
  const specificSettings = require(path).settings
...
exports.indexSettings = settings
