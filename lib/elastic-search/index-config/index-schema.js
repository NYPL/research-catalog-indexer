const propertyTemplates = {
  ...
  identifierClean: (identifierName) => ({
    type: 'keyword',
    fields: {
      clean: {
        type: 'keyword',
        ignore_above: 256,
        normalizer: require('./identifiers').mappings.properties[identifierName].normalizer
      }
    }
  }),
  boolean: {
...
// exists in dev & prod.
exports.schema = () => ({
  addedAuthorTitle: propertyTemplates.textWithFilterableKeyword,
  contributorNameTitle: propertyTemplates.textWithFilterableKeyword,
  buildingLocationIds: {
    type: 'keyword',
    eager_global_ordinals: true
  },
  ...
  contentsTitle: propertyTemplates.textWithFilterableKeyword,
  // contains names and names + roles as individual items to use with contributor browse index
  browseableContributorRole_packed: propertyTemplates.packed,
  // contains names (matching browse index) packed with full contributor label (name, prefix, title, roles)
  contributor_displayComponents: propertyTemplates.displayComponents,
  contributorLiteral: propertyTemplates.textWithFilterableKeyword,
  ...
  creator_displayComponents: propertyTemplates.displayComponents,
  creatorLiteral: propertyTemplates.textWithFilterableKeyword,
  ...
  donor: propertyTemplates.fulltextWithRawFoldedAndKLS,
  editionStatement: propertyTemplates.fulltextWithRawFolded,
  ...
  formerTitle: propertyTemplates.textWithFilterableKeyword,
  genreForm: propertyTemplates.fulltextWithRawFoldedAndKLS,
  holdings: {
    type: 'nested',
    properties: {
      checkInBoxes: {
  ...
  idIsbn: propertyTemplates.identifierClean('isbn'),
  idIssn: propertyTemplates.identifierClean('issn'),
  idLccn: propertyTemplates.identifierClean('lccn'),
  idOclc: propertyTemplates.identifierClean('oclc'),
  ...
  parallelAddedAuthorTitle: propertyTemplates.textWithFilterableKeyword,
  parallelContributorNameTitle: propertyTemplates.textWithFilterableKeyword,
  parallelCreatorLiteral: propertyTemplates.textWithFilterableKeyword,
  parallelCreators_displayComponents: propertyTemplates.displayComponents,
  parallelContributorLiteral: propertyTemplates.textWithFilterableKeyword,
  parallelContributors_displayComponents: propertyTemplates.displayComponents,
  parallelEditionStatement: propertyTemplates.fulltextWithRawFolded,
  parallelNote: {
    properties: {
      label: propertyTemplates.foldingStemmed,
      noteType: propertyTemplates.exactString,
  ...
  parallelPlaceOfPublication: propertyTemplates.textWithFilterableKeyword,
  parallelPublicationStatement: propertyTemplates.exactStringNotIndexed,
  parallelPublisherLiteral: propertyTemplates.textWithFilterableKeyword,
  parallelSeries: propertyTemplates.textWithFilterableKeyword,
  parallelSeriesUniformTitle: propertyTemplates.textWithFilterableKeyword,
  parallelSeriesAddedEntry: propertyTemplates.textWithFilterableKeyword,
  parallelSeries_displayComponents: propertyTemplates.displayComponents,
  parallelSeriesUniformTitle_displayComponents: propertyTemplates.displayComponents,
  parallelSeriesAddedEntry_displayComponents: propertyTemplates.displayComponents,
  parallelSubjectLiteral: propertyTemplates.textWithFilterableKeyword,
  parallelTableOfContents: propertyTemplates.fulltextFolded,
  parallelTitle: propertyTemplates.textWithFilterableKeyword,
  parallelTitleAlt: propertyTemplates.textWithFilterableKeyword,
  parallelTitleDisplay: propertyTemplates.textWithFilterableKeyword,
  parallelUniformTitle: propertyTemplates.textWithFilterableKeyword,
  parallelSummary: propertyTemplates.foldingStemmed,
  partOf: propertyTemplates.exactString,
  physicalDescription: propertyTemplates.exactStringNotIndexed,
  placeOfPublication: propertyTemplates.textWithFilterableKeyword,
  popularity: propertyTemplates.number,
  publisherLiteral: propertyTemplates.fulltextWithRawFoldedAndKLS,
  ...
  series: propertyTemplates.textWithFilterableKeyword,
  seriesUniformTitle: propertyTemplates.textWithFilterableKeyword,
  seriesAddedEntry: propertyTemplates.textWithFilterableKeyword,
  series_displayComponents: propertyTemplates.displayComponents,
  seriesUniformTitle_displayComponents: propertyTemplates.displayComponents,
  seriesAddedEntry_displayComponents: propertyTemplates.displayComponents,
  shelfMark: {
    // We're indexing this as text only so that it can be used in query_string
    // fulltext searches (if indexed keyword, can't by used fuzzily)
    type: 'text',
  ...
  summary: propertyTemplates.foldingStemmed,
  subjectLiteral: propertyTemplates.fulltextWithRawFoldedAndKLS,
  ...
  titleAlt: propertyTemplates.textWithFilterableKeyword,
  titleDisplay: propertyTemplates.textWithFilterableKeyword,
  type: propertyTemplates.exactString,
  uniformTitle: propertyTemplates.textWithFilterableKeyword,
  updatedAt: { type: 'date' },
  uri: propertyTemplates.identifierClean('bnumber'),
