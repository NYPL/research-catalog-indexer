...
exports.schema = () => ({
  ...
  idIsbn: propertyTemplates.identifier('isbn'),
  idIssn: propertyTemplates.identifier('issn'),
  idLccn: propertyTemplates.identifier('lccn'),
  idOclc: propertyTemplates.identifier('oclc'),
  ...
  updatedAt: { type: 'date' },
  uri: propertyTemplates.identifier('bnumber'),
