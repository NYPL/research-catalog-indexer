...
exports.schema = () => ({
  ...
  contributors_displayPacked: propertyTemplates.packed,
  ...
  creators_displayPacked: propertyTemplates.packed,
  ...
  parallelCreators_displayPacked: propertyTemplates.packed,
  parallelContributorLiteral: propertyTemplates.textWithFilterableKeyword,
  parallelContributors_displayPacked: propertyTemplates.packed,
  ...
  parallelSeries_displayPacked: propertyTemplates.packed,
  parallelSeriesUniformTitle_displayPacked: propertyTemplates.packed,
  parallelSeriesAddedEntry_displayPacked: propertyTemplates.packed,
  ...
  series_displayPacked: propertyTemplates.packed,
  seriesUniformTitle_displayPacked: propertyTemplates.packed,
  seriesAddedEntry_displayPacked: propertyTemplates.packed,
  shelfMark: {
    // We're indexing this as text only so that it can be used in query_string
    // fulltext searches (if indexed keyword, can't by used fuzzily)
    type: 'text',
