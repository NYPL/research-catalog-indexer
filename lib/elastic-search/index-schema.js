...
// exists in dev & prod.
exports.schema = () => ({
  addedAuthorTitle: propertyTemplates.fulltextWithRawFoldedNonAgg,
  buildingLocationIds: {
    type: 'keyword',
    eager_global_ordinals: true
  },
  ...
  donor: propertyTemplates.fulltextWithRawFoldedNonAgg,
  ...
  titleAlt: propertyTemplates.fulltextWithRawFoldedNonAgg,
  titleDisplay: propertyTemplates.fulltextFolded,
  type: propertyTemplates.exactString,
  uniformTitle: propertyTemplates.fulltextWithRawFoldedNonAgg,
  updatedAt: { type: 'date' },
  uri: propertyTemplates.exactString,
