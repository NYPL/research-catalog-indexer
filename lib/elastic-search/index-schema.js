...
const schema = () => ({
  ...
  parallelAddedAuthorTitle: propertyTemplates.fulltextWithRawFolded,
  ...
  parallelSeries: propertyTemplates.filterableKeyword,
  parallelSeriesUniformTitle: propertyTemplates.filterableKeyword,
  parallelSeriesAddedEntry: propertyTemplates.filterableKeyword,
  // the following do not reflect what is in ES
  ...
  parallelTitleAlt: propertyTemplates.fulltextWithRawFolded,
  parallelTitleDisplay: propertyTemplates.fulltextFolded,
  parallelUniformTitle: propertyTemplates.fulltextWithRawFolded,
  ...
  series: propertyTemplates.filterableKeyword,
  seriesUniformTitle: propertyTemplates.filterableKeyword,
  seriesAddedEntry: propertyTemplates.filterableKeyword,
...
module.exports = { propertyTemplates, schema }
