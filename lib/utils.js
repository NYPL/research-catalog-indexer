 ...
 *
 *  Useful when you you have an array of simple scalar values and you want
 *  to count their distinct frequencies
 *
 *  @example
 ...
 *
 *  Useful when you have an array of objects that don't have a single ready
 *  property for grouping, but you can build a callback function to derive
 ...
 *
 *  Useful when you need to order a array of scalar values against a rather
 *  arbitrary static list of values (i.e. "keep the current order, but put these first")
 *
 *  @example
